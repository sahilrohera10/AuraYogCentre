...
import vd1 from "../assets/testimonial1.mp4";
import vd2 from "../assets/testimonial2.mp4";
  ...
  return (
    <div style={{ background: "blanchedalmond" }}>
      <div className="lg:px-20 md:px-6 px-4 py-12">
        ...
        <div className="w-full lg:flex justify-center items-center gap-6 mt-10">
          <div className="lg:w-2/6">
            <div className=" border rounded-md border-gray-200 relative sm:p-10 p-6">
              <video
