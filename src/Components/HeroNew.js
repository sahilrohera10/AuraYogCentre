      ...
      <div className="lg:px-2 xl:px-0">
        <div className="container mx-auto relative z-20">
          <nav className="w-full absolute">
            <div className="hidden lg:flex w-full f-f-p justify-between items-center py-2 relative">
              {/* <div className="w-2/3">
                <svg
              ...
              <div className="flex">
                ...
                <p className="mt-4 ml-5 font-bold text-2xl">AURA YOG CENTRE</p>
              </div>
        ...
        <div className="mx-auto container relative z-0 px-4 xl:px-0">
          <div className="flex flex-col-reverse md:flex-row">
            <div className="md:w-3/5 md:pt-24 pb-10 lg:py-32 xl:py-60">
              <h1 className="text-3xl lg:text-3xl xl:text-6xl font-black text-gray-900 text-center md:text-left tracking-tighter f-f-i md:w-7/12 leading-tight text-heading-color">
            ...
            <div className="mt-20 w-1/2 h-52 md:ml-10 sm:ml-28">
              {/* <img class="h-full" src="https://cdn.tuk.dev/assets/components/111220/Hero4/Rectangle.png" alt="Device"> */}
              <img className="rounded-full mt-10 sm:ml-20" src={g3} alt />
            </div>
          </div>
        </div>
      </div>
